...
async def test_weatherlight_flushes_tamiyo_history(
    ...
    try:
        ...
        seed.seed_id = "seed-weatherlight"
        ...
        async def _fake_metrics_snapshot(**_kwargs: object) -> dict[str, float]:
            return {"queue_depth_normal": 0.0, "queue_depth_emergency": 0.0}

        monkeypatch.setattr(service._oona, "metrics_snapshot", _fake_metrics_snapshot)
