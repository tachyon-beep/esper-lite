...
def test_germinate_wait_prune_cycle_discounted_return_not_positive() -> None:
    ...
    - Epoch progress bonuses break PBRS telescoping across a stage transition.
    """
    ...
    # Step 3: PRUNE back to failure state (stage regression).
    pruned_info = _make_seed_info(
        stage=SeedStage.PRUNED,
        epochs_in_stage=0,
        previous_stage=SeedStage.GERMINATED,
