...
# Schema v2 adds escrow Markov state:
# - base stable_val_acc_for_observation
# - per-slot escrow_credit_prev
# For DEFAULT_NUM_SLOTS=3: 24 + (32 × 3) = 120 dims.
# The full Obs V3 input to the network is:
#   OBS_V3_NON_BLUEPRINT_DIM + (DEFAULT_NUM_SLOTS × DEFAULT_BLUEPRINT_EMBED_DIM) = 132 dims.
OBS_V3_FEATURE_SCHEMA_VERSION = 2
OBS_V3_BASE_FEATURE_SIZE = 24
OBS_V3_SLOT_FEATURE_SIZE = 32
