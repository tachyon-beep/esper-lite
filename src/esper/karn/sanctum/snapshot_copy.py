...
def copy_tamiyo_state(tamiyo: TamiyoState) -> TamiyoState:
    return replace(
        ...
        ev_main_history=copy_deque(tamiyo.ev_main_history),
        ev_cf_history=copy_deque(tamiyo.ev_cf_history),
        cf_value_loss_history=copy_deque(tamiyo.cf_value_loss_history),
        return_var_cf_share_history=copy_deque(tamiyo.return_var_cf_share_history),
        action_counts=dict(tamiyo.action_counts),
        cumulative_action_counts=dict(tamiyo.cumulative_action_counts),
        head_clip_fraction=dict(tamiyo.head_clip_fraction),
        head_learnable_fraction=dict(tamiyo.head_learnable_fraction),
        head_gradient_state=dict(tamiyo.head_gradient_state),
