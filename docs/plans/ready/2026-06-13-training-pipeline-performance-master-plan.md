...
#### P2-RESET — Model/optimizer reuse via `reset_to_initial()` **[DEFERRED — gated]**
...
- **Go/No-Go (after P2-STREAMPOOL + P2-DEL + P0-ALLOC land, ≥20 batches on the real config):**
  - **NO-GO:** `fragmentation_bytes/reserved_bytes < 0.15` **and** retries flat **and** no OOMs → don't build it.
