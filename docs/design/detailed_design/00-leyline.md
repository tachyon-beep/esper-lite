...
enum SeedLifecycleStage {
  ...
  SEED_STAGE_GERMINATING = 1;
  SEED_STAGE_TRAINING = 2;
  SEED_STAGE_GRAFTING = 3;
  SEED_STAGE_STABILIZING = 4;
  SEED_STAGE_EVALUATING = 5;
  SEED_STAGE_FINE_TUNING = 6;
  SEED_STAGE_FOSSILIZED = 7;
  SEED_STAGE_CULLING = 8;
  SEED_STAGE_CANCELLED = 9;
}
