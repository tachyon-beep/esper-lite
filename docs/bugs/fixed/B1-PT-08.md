...
| **Severity** | `P4` |
| **Status** | `closed` |
| **Resolution** | `duplicate (fixed in B1-DRL-06)` |
| **Batch** | 1 |
| **Agent** | `pytorch` |
| **Domain** | `tolaria` |
| **Assignee** | |
...
Duplicate of B1-DRL-06. Fix already applied: governor.py now uses typed `GovernorRollbackPayload` dataclass (lines 21, 304) instead of untyped dict with `# type: ignore`.
