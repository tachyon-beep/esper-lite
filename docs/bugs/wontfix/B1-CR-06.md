...
1. **mypy passes** — No actual type errors are flagged
2. **Inferred correctly** — mypy/pyright infer `Parameter` type from optimizer usage
3. **P4 trivial** — All agents neutral, pure IDE convenience

Adding explicit annotation provides no practical benefit.
