...
- **Contracts:** Event types in `leyline/telemetry.py`; TrainingSignals in `leyline/signals.py`; Obs V3 feature construction in `tamiyo/policy/features.py` (120 non-blueprint dims + blueprint embeddings).
