...
| committed-shapley-topup-build | Committed-Shapley Synergy Top-Up (default-OFF build) | planning | high | L | medium | Owner build sign-off 2026-07-02 (PDR-0012); plan `docs/plans/ready/2026-07-02-committed-shapley-topup-build.md`; all evidence gates passed (GATE 1, GATE 2 retro-write mandated PDR-0011, signal verification, reward-function-reviewer APPROVE_WITH_CHANGES); awaiting drl-expert + pytorch-expert plan review, then TDD build; flag stays `shapley_synergy_scale=0.0` — enablement is a separate later gate; tracker esper-lite-254175df90 |
