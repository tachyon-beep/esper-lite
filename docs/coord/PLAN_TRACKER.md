...
| pin-e-placebo-harness | PIN-E Placebo Noise-Floor Harness (tau calibration) | ready | high | M | medium | Drafted 2026-07-03 (PDR-0014, owner opened the enablement gate via this leg): near-inert small-real placebo blueprint (tiny-random single-layer delta, seed_lr=0) held at HOLDING α=1 under a new declared schedule (never fossilizes — fossilized slots are ablation-invisible at scale=0); measures per-stage LOO bias/std/CoV + terminal φ-noise → tau recommendation for esper-lite-f22a1d48a7. Plan `docs/plans/ready/2026-07-03-pin-e-placebo-harness.md`; tracker esper-lite-94869250f1 (blocks the enablement gate). Under drl-expert + pytorch-expert review; `shapley_synergy_scale` stays 0.0 throughout |
