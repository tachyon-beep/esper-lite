...
|--------|--------|---------|---------|
| corr(reward, J) — reward aligned to the J yardstick (EPISODE-level: episode-summed reward vs episode J) | **A/B n=5 direction gate: paired Δcorr ≥ +0.10 absolute (PDR-0018)**; step-level is NOT the gate (F2 sampling ceiling) | **0.212 ± 0.046 (weak)**; probe recheck 0.179–0.261 per seed; corr(J,Σba) ≡ corr(J,Σreward) — ba is the reward's entire J-relevant content | 2026-07-03 (n=5) |
